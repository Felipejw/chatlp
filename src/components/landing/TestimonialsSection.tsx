...
const testimonials = [
  {
    ...
    initials: "RM",
    text: "Eu pagava R$297 por mês em outra plataforma. Hoje paguei R$97 uma única vez e economizei mais de R$3.000 no ano. Tenho controle total do meu atendimento.",
    featured: true,
  },
  {
