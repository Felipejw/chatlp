...
const testimonials = [
  {
    ...
    initials: "RM",
    text: "Eu pagava R$400 por mês em outra plataforma. Hoje paguei R$97 uma única vez, já veio instalado, e economizei mais de R$4.000 no ano. Tenho controle total do meu atendimento.",
    featured: true,
  },
  {
