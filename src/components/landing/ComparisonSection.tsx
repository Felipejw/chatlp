...
const diferenciais = [
  { icon: CreditCard, title: "Pague Uma Vez. Use Para Sempre.", desc: "Enquanto outras plataformas cobram R$200 ou mais todos os meses, você investe R$97 uma única vez e recebe o sistema já instalado.", featured: true },
