...
const faqs = [
  { q: "É pagamento único mesmo?", a: "Sim. Você paga apenas R$97 uma única vez e o sistema é seu, já instalado. Sem mensalidade, sem taxa recorrente e sem surpresas futuras." },
